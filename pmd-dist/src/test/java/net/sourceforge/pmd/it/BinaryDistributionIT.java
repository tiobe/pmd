...
public class BinaryDistributionIT extends AbstractBinaryDistributionTest {
    ...
    static {
        ...
        if (PMDExecutor.isJava7Test()) {
            SUPPORTED_LANGUAGES_CPD = "Supported languages: [coco, cpp, cs, dart, fortran, gherkin, go, groovy, java, jsp, julia, kotlin, lua, matlab, modelica, objectivec, perl, php, plsql, powershell, python, ruby, swift, xml]";
            SUPPORTED_LANGUAGES_PMD = "java, jsp, modelica, plsql, pom, vm, wsdl, xml, xsl";
        } else {
            SUPPORTED_LANGUAGES_CPD = "Supported languages: [apex, coco, cpp, cs, dart, ecmascript, fortran, gherkin, go, groovy, html, java, jsp, julia, kotlin, lua, matlab, modelica, objectivec, perl, php, plsql, powershell, python, ruby, scala, swift, vf, xml]";
